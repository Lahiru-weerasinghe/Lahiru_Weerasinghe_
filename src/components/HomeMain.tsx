        ...
        <HanzContainer>
            <div className="row">
                ...
                <div className="col-lg-8 align-self-center text-center text-lg-start">
                    <h4 className="fw-bold">Lahiru Weerasinghe</h4>
                    <h6 id="">Software Engineer | Masters student</h6>
                </div>
            </div>
                ...
                <div className="col">
                    <ul className="list-inline">
                        {/* <li className="list-inline-item me-4">
                            <a href="https://scholar.google.com/citations?user=ZN96WzcAAAAJ&hl=en"
                               target="_blank">
                        ...
                        <li className="list-inline-item me-4">
                            <a href="https://github.com/Lahiru-weerasinghe" target="_blank">
                                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                                     width="20" height="20"
                                     viewBox="0 0 16 16"
                                     fill="currentColor">
                        ...
                        <li className="list-inline-item me-4">
                            <a href="https://www.linkedin.com/in/lahiru-weerasinghe/" target="_blank">
                                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                                     width="20" height="20"
                                     viewBox="0 0 16 16"
                                     fill="currentColor">
                        ...
                        <li className="list-inline-item">
                            <a href="https://stackoverflow.com/users/16666432/lahiru-weerasinghe"
                               target="_blank">
                                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                                     width="20" height="20"
                                     viewBox="0 0 16 16"
