    ...
    return (<div className="d-none d-xl-block container shadow-sm hanz-container">
            <blockquote className="instagram-media"
                ...
                <div style={{padding: '16px'}}><a
                    ...
                    whiteSpace: 'nowrap'
                }}><a href="https://www.instagram.com/hanz.lkw/?utm_source=ig_embed&utm_campaign=loading" style={{
                    color: '#c9c8cd',
                    fontFamily: 'Arial,sans-serif',
                    fontSize: '14px',
                    fontStyle: 'normal',
                    fontWeight: 'normal',
                    lineHeight: '17px'
                }} target="_blank">Lahiru Weerasinghe</a> (@<a
                    href="https://www.instagram.com/hanz.lkw/?utm_source=ig_embed&utm_campaign=loading" style={{
                    color: '#c9c8cd',
                    fontFamily: 'Arial,sans-serif',
                    fontSize: '14px',
                    ...
                    fontWeight: 'normal',
                    lineHeight: '17px'
                }} target="_blank">hanz.lkw</a>) • Instagram photos and videos</p></div>
            </blockquote>
        </div>
    );
}